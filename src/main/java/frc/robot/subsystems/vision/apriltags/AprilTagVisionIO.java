...
public interface AprilTagVisionIO {
    class CameraInputs {
        ...
        public void fromPhotonPipeLine(PhotonPipelineResult pipelineResult, boolean cameraConnected) {
            ...
            this.resultsDelaySeconds = pipelineResult.metadata.getLatencyMillis() / 1000.0;
            ...
            if(  pipelineResult != null && pipelineResult.getMultiTagResult() != null && pipelineResult.getMultiTagResult().isPresent() && pipelineResult.getMultiTagResult().get().estimatedPose != null && pipelineResult.getMultiTagResult().get().estimatedPose.best != null)
            {
                this.bestFieldToCamera = Optional.of(pipelineResult.getMultiTagResult().get().estimatedPose.best);
